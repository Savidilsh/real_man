...
void HandFollowPos_Callback(const dual_arm_msgs::Hand_Angle msg)
{
    int res = 0;
    int i = 0;
...
void HandFollowAngle_Callback(const dual_arm_msgs::Hand_Angle msg)
{
    int res = 0;
    int i = 0;
    int16_t hand_angle[6];
...
//自定义模式位姿透传力位混合补偿
void ForcePositionMovePoseCustom_Callback(const dual_arm_msgs::Force_Position_Move_Pose_Custom msg)
{
    int res = 0;
    POSE target;
    target = Quater_To_Euler(msg.Pose);
...
void MoveJ_Fd_Custom_Callback(const dual_arm_msgs::JointPosCustom msg)
{
    int res = 0;
    int i = 0;
    float joint[7];
...
void Movep_Fd_Custom_Callback(const dual_arm_msgs::CartePosCustom msg)
{
    // ROS_INFO("enter Movep_Fd_Callback");
    int res = 0;
    byte speed;
...
void Set_Modbus_Mode_Callback(const dual_arm_msgs::Set_Modbus_Mode msg)
{
    int res = 0;
...
void Set_Modbustcp_Mode_Callback(const dual_arm_msgs::Set_Modbus_Mode msg)
{
    int res = 0;
...
void Read_Coils_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Read_Multiple_Coils_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Write_Single_Coil_Callback(const dual_arm_msgs::Write_Register msg)
{
    int res=0;  
    if(msg.data.size() == 1)
    {
...
void Write_Coils_Callback(const dual_arm_msgs::Write_Register msg)
{
    int res=0;
...
void Read_Input_Status_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Read_Holding_Registers_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Write_Single_Register_Callback(const dual_arm_msgs::Write_Register msg)
{
    int res=0;
    if(msg.data.size() == 1)
    {
...
void Write_Registers_Callback(const dual_arm_msgs::Write_Register msg)
{
    int res=0;
...
void Read_Multiple_Holding_Registers_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Read_Input_Registers_Callback(const dual_arm_msgs::Read_Register msg)
{
...
void Read_Multiple_Input_Registers_Callback(const dual_arm_msgs::Read_Register msg)
{
...
int main(int argc, char **argv)
{
    ...
    pub_getControllerRS485Mode_result = nh_.advertise<dual_arm_msgs::RS485_Mode>("rm_driver/Get_Controller_RS485_Mode_Result",10);
    sub_getToolRS485Mode = nh_.subscribe("rm_driver/Get_Tool_RS485_Mode", 10, Get_Tool_RS485_Mode_Callback);
    pub_getToolRS485Mode_result = nh_.advertise<dual_arm_msgs::RS485_Mode>("rm_driver/Get_Tool_RS485_Mode_Result",10);
    ...
    pub_readCoils_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Coils_Result",10);
    sub_readMultipleCoils = nh_.subscribe("rm_driver/Read_Multiple_Coils", 10, Read_Multiple_Coils_Callback);
    pub_readMultipleCoils_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Coils_Result",10);
    ...
    pub_readInputStatus_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Input_Status_Result",10);
    sub_readHoldingRegisters = nh_.subscribe("rm_driver/Read_Holding_Registers", 10, Read_Holding_Registers_Callback);
    pub_readHoldingRegisters_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Holding_Registers_Result",10);
    ...
    pub_readMultipleHoldingRegisters_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Holding_Registers_Result",10);
    sub_readInputRegisters = nh_.subscribe("rm_driver/Read_Input_Registers", 10, Read_Input_Registers_Callback);
    pub_readInputRegisters_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Input_Registers_Result",10);
    ...
    pub_readMultipleInputRegisters_result = nh_.advertise<dual_arm_msgs::Register_Data>("rm_driver/Read_Multiple_Input_Registers_Result",10);
    ...
    Get_Arm_Software_Version_Result = nh_.advertise<dual_arm_msgs::Arm_Software_Version>("rm_driver/Get_Arm_Software_Version_Result", 10);
    /********************************************udp配置参数修改控制********************************************/
    ...
    Get_Realtime_Push_Result = nh_.advertise<dual_arm_msgs::Set_Realtime_Push>("rm_driver/Get_Realtime_Push_Result", 10);
    /********************************************力传感器外力数据********************************************/
    ...
    pub_UdpError = nh_.advertise<dual_arm_msgs::Err>("rm_driver/Error", 100);
    ...
    // publisher
    ChangeTool_Name = nh_.advertise<dual_arm_msgs::ChangeTool_State>("rm_driver/ChangeTool_State", 10);
    ChangeWorkFrame_Name = nh_.advertise<dual_arm_msgs::ChangeWorkFrame_State>("rm_driver/ChangeWorkFrame_State", 10);
    ...
    Arm_IO_State = nh_.advertise<dual_arm_msgs::Arm_IO_State>("rm_driver/Arm_IO_State", 10);
    Tool_IO_State = nh_.advertise<dual_arm_msgs::Tool_IO_State>("rm_driver/Tool_IO_State", 10);
    Plan_State = nh_.advertise<dual_arm_msgs::Plan_State>("rm_driver/Plan_State", 10);
    pub_PoseState = nh_.advertise<geometry_msgs::Pose>("rm_driver/Pose_State", 10);
    pub_HandStatus = nh_.advertise<dual_arm_msgs::Hand_Status>("rm_driver/Udp_Hand_Status", 1);
    pub_RmPlusState = nh_.advertise<dual_arm_msgs::Rm_Plus_State>("rm_driver/Udp_Plus_State", 1);
    pub_RmPlusBase = nh_.advertise<dual_arm_msgs::Rm_Plus_Base>("rm_driver/Udp_Plus_Base", 1);
    pub_currentJointCurrent = nh_.advertise<dual_arm_msgs::Joint_Current>("rm_driver/Joint_Current", 10);
    pub_liftState = nh_.advertise<dual_arm_msgs::LiftState>("rm_driver/LiftState", 10);
    pub_setGripperResult = nh_.advertise<std_msgs::Bool>("rm_driver/Set_Gripper_Result", 10);

    pub_ArmCurrentStatus = nh_.advertise<dual_arm_msgs::Arm_Current_Status>("rm_driver/Udp_Arm_Current_status",10);
    pub_JointCurrent = nh_.advertise<dual_arm_msgs::Joint_Current>("rm_driver/Udp_Joint_Current",10);
    pub_JointEnFlag = nh_.advertise<dual_arm_msgs::Joint_En_Flag>("rm_driver/Udp_Joint_En_Flag",10);
    pub_JointSpeed = nh_.advertise<dual_arm_msgs::Joint_Speed>("rm_driver/Udp_Joint_Speed",10);
    pub_JointTemperature = nh_.advertise<dual_arm_msgs::Joint_Temperature>("rm_driver/Udp_Joint_Temperature",10);
    pub_JointVoltage = nh_.advertise<dual_arm_msgs::Joint_Voltage>("rm_driver/Udp_Joint_Voltage",10);
    pub_PoseEuler = nh_.advertise<dual_arm_msgs::Joint_PoseEuler>("rm_driver/Udp_Joint_PoseEuler",10);
    pub_LiftInPosition = nh_.advertise<dual_arm_msgs::Lift_In_Position>("rm_driver/Lift_InPosition",10);
    /******************************************************************************************/
