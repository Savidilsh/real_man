...
class BasicBlock(spconv.SparseModule):
    ...
    def __init__(
        ...
        if in_channels == embed_channels:
            ...
            self.proj_conv = Custom1x1Subm3d(
...
class SpUNetBase(nn.Module):
    def __init__(
        ...
        self.conv_input = SPConvPatchEmbedding(
            in_channels, base_channels, kernel_size=3, norm_fn=norm_fn
        )
        ...
        final_out_channels = num_classes if num_classes > 0 else out_channels
        self.final = Custom1x1Subm3d(
            final_in_channels, final_out_channels, kernel_size=1, bias=True
        )
    ...
    def forward(self, input_dict):
        ...
        # cast context dtype
        context = context.to(x.features.dtype)
